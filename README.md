...
Les operacions exposades es consumiràn de manera síncrona enviant una petició amb un element `SolicitudTransmision` 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYwNjgxNjkyMywyNDM5NDI2MjMsMTA0MT
