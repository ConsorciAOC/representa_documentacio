...
Per exemple en l'alta d'una representació, per l'element `representacio` és obligatori informar com a mínim els camps: tipusRepresentacio, estat, poderdant, 
## 3.1 Representacio
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNjc0NTQ2ODAsMTExMTAwOTMxMSw4Mz
